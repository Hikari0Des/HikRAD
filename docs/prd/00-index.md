...
| 05 | [05-billing-payments-vouchers.md](05-billing-payments-vouchers.md) | Renewals, immutable ledger, agent balances, receipts, vouchers, e-wallet gateway interface, scratch-card manual payments; **v2: full multi-currency (IQD/USD/EUR), per-currency balances + explicit exchange** | FR-19–26, FR-59, FR-68–70 | — | E-wallet-availability risk · OQ-1 (gateway priority) | 5th (P3, gateways P5; v2 phase 4) |
