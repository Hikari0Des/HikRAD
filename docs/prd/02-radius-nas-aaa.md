...
Full request/response shapes, the resolution enum, and the `management_mode` state machine are frozen in [docs/v2/phases/phase-v2-3-autosetup-config-manager/00-phase.md](../v2/phases/phase-v2-3-autosetup-config-manager/00-phase.md).
