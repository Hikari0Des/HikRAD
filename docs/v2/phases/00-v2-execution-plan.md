...
| 3 | v2-4 | [04-multi-currency.md](../04-multi-currency.md) — full IQD/USD/EUR billing (item 16) | `phase-v2-4-multi-currency/` | 0530–0539 | Money-core rework; isolated from the NAS work above |
