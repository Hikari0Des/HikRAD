...
| v2-3 | [04-multi-currency.md](../04-multi-currency.md) — full IQD/USD/EUR billing (item 16) | `phase-v2-3-multi-currency/` | 0530–0549 | Money-core rework; isolated from the NAS work above |
...
Re-ordering is allowed (owner's call) — the only hard dependencies are: v2-2 after v2-1; v2-7 after v2-3 if settlements are non-IQD; v2-5 before or with v2-6's registry work.
