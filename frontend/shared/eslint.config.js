...
export default tseslint.config(
  { ignores: ['dist', 'node_modules', 'test/fixtures'] },
  {
    ...
    rules: {
      ...
      // Contract C8 / NFR-6.2: layout must use logical properties so RTL
      // mirrors for free. Physical left/right Tailwind utilities are banned
      // (use ms-/me-/ps-/pe-/start-/end-/text-start/text-end). The CSS-side
      // twin of this rule lives in stylelint.config.mjs.
