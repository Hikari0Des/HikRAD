...
// consumed the shared branding context correctly pre-phase — it was the
// endpoint the context fetches from that silently served defaults (see
...
describe('portal BrandedManifestLink (FR-92, contract C7)', () => {
