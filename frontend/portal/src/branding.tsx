...
/**
 * ISP branding (FR-43): name/logo/colors read once from the public branding
 * endpoint (contract C5) and applied at runtime — no rebuild per ISP. Falls
 * back to the generic HikRAD identity while loading or if the endpoint is
 * unreachable (NFR-7), so the login screen is never blocked on it.
 */
